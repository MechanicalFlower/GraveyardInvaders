@tool
class_name SleepDecorator
extends CooldownDecorator

## The Sleep Decorator will return 'RUNNING' for a set amount of time
## after executing its child.
## The timer resets the next time its child is executed and it is `RUNNING`.
